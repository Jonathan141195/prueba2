...
function TableProductoHead(props) {
...
function TableProductoToolbar(props) {
...
TableProductoToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  idSelected: PropTypes.number.isRequired,
};

export default function TableProducto() {
        ...
        <Grid container>
          <Grid item xs={12}>
            <Paper sx={{ width: '100%', mb: 2, mt: 4, p: 2, borderRadius: 2, boxShadow: 3 }}>
              <TableProductoToolbar numSelected={selected.length} idSelected={Number(selected[0]) || 0} />
              <TableContainer>
                <Table
                  sx={{ minWidth: 750 }}
